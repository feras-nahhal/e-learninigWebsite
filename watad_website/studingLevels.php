  ...
  <div class="row g-4 justify-content-center">
    ...
    <div class="col-md-4">
      ...
      <div class="collapse grade-list" id="prepGrades">
        <div class="grade-card"><a href="grade7.html">الصف السابع</a></div>
        <div class="grade-card"><a href="grade8.html">الصف الثامن</a></div>
        <div class="grade-card"><a href="grade9.html">الصف التاسع</a></div>
      </div>
    </div>
    ...
    <div class="col-md-4">
      ...
      <div class="collapse grade-list" id="secondaryGrades">
        <!-- الصف العاشر -->
        <div class="grade-card"><a href="grade10.html">الصف العاشر</a></div>
        ...
        <div class="collapse sub-grade" id="grade11Sub">
          <a href="grade11-science.html">علمي</a>
          <a href="grade11-arts.html">أدبي</a>
        </div>
        ...
        <div class="collapse sub-grade" id="grade12Sub">
          <a href="grade12-science.html">علمي</a>
          <a href="grade12-arts.html">أدبي</a>
        </div>
      </div>
    </div>
